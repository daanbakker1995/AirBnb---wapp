...
{
    public partial class AirbnbV2Context : DbContext
    {
        public AirbnbV2Context()
        {
        }

        public AirbnbV2Context(DbContextOptions<AirbnbV2Context> options)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Airbnb_v2");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Listing>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Latitude, e.Longitude }, "geoindex");
            ...
            modelBuilder.Entity<Review>(entity =>
            {
                ...
                entity.HasIndex(e => e.Date, "cooleindex");
